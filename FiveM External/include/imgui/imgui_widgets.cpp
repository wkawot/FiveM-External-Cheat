...
bool ImGui::ButtonEx(const char* label, const ImVec2& size_arg, ImGuiButtonFlags flags)
{
    ...
    window->DrawList->AddRectFilled(rect.Min, rect.Max, ImColor(255,10,10, it_anim->second.active_rect_alpha), 3.f);
...
bool ImGui::Checkbox(const char* label, bool* v)
{
    ...
    window->DrawList->AddRectFilled(rect.Max - ImVec2(12, 12), rect.Max, ImColor(255,10,10, it_anim->second.active_rect_alpha), 2.f);
...
bool ImGui::BeginCombo(const char* label, const char* preview_value, ImGuiComboFlags flags)
{
    ...
    window->DrawList->AddCircleFilled(rect.Max - ImVec2(11, 13), 3.f + it_anim->second.active_circle_anim, ImColor(255,10,10, 255));
...
bool ImGui::SliderScalar(const char* label, ImGuiDataType data_type, void* p_data, const void* p_min, const void* p_max, const char* format, ImGuiSliderFlags flags)
{
    ...
    window->DrawList->AddRectFilled(clickable.Min + ImVec2(0.f, 7.f), grab_bb.Max - ImVec2(10.f, 5.f), ImColor(255,10,10, 255));
    window->DrawList->AddCircleFilled(grab_bb.Min + ImVec2(5.f, 6.f), 5.f + it_anim->second.circle_anim, ImColor(255,10,10, 255), 30.f);
    window->DrawList->AddText(rect.Min, ImColor(255, 255, 255, 255), label);
